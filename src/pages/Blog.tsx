...
const blogs = [
  {
    id: 1,
    title: {
      en: "THE SOUL OF THE SOIL - SRI LANKA’S RURAL FARMERS",
      de: "Die Schönheit der Natur entdecken",
      ja: "自然の美しさを探る",
    },
    date: "2025-08-20",
    image: "https://placehold.co/600x400?text=Nature",
    excerpt: {
      en: "Discover how spending time in nature boosts creativity.",
      de: "Erfahre, wie Zeit in der Natur deine Kreativität fördert.",
      ja: "自然の中で過ごすと創造力が高まります。",
    },
    pdf: "/natures-aroma/media/sample blog.pdf",
  },
  {
    id: 2,
    title: {
      en: "SRILANKA'S TIMELESS SECRET TO PURE OIL",
      de: "KI im Jahr 2025 — Was kommt als Nächstes?",
      ja: "2025年のAI — 次に来るものは？",
    },
    date: "2025-09-05",
    image: "https://placehold.co/600x400?text=AI",
    excerpt: {
      en: "AI is evolving rapidly. Here's what's coming.",
      de: "KI entwickelt sich rasant weiter.",
      ja: "AIは急速に進化しています。",
    },
    pdf: "/natures-aroma/media/sekkuwa.pdf",
  },
  {
    id: 3,
    title: {
    ...
    image: "https://placehold.co/600x400?text=React+TS",
    excerpt: {
      en: "A guide for leveling up your React apps.",
      de: "Ein Leitfaden für bessere React-Apps.",
      ja: "Reactアプリを強化するガイドです。",
    },
    pdf: dummyPDF,
  },
  {
    id: 4,
    title: {
      en: "Building Modern UI with MUI",
      de: "Moderne UI mit MUI erstellen",
      ja: "MUIでモダンUIを構築する",
    },
    date: "2025-06-10",
    image: "https://placehold.co/600x400?text=MUI+Motion",
    excerpt: {
      en: "Combine MUI & Framer Motion for smooth UI.",
      de: "MUI & Framer Motion für flüssige UI.",
      ja: "MUIとFramer Motionで滑らかなUI。",
    },
    pdf: dummyPDF,
  },
  {
    ...
    title: {
      en: "Tech Trends in 2024",
      de: "Technologietrends 2024",
      ja: "2024年のテクノロジートレンド",
    },
    date: "2024-12-22",
    image: "https://placehold.co/600x400?text=Tech+2024",
    excerpt: {
      en: "A look back at 2024 tech changes.",
      de: "Technologische Veränderungen 2024.",
      ja: "2024年の技術変化を振り返る。",
    },
    pdf: dummyPDF,
  },
...
const Blog = () => {
  ...
  // 🔹 Disable scroll when PDF is open
  useEffect(() => {
    document.body.style.overflow = openPdf ? "hidden" : "auto";
  }, [openPdf]);
