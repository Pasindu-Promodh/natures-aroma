...
const blogs = [
  {
    ...
    date: "2025-08-20",
    image: "/natures-aroma/media/blogs/The Soul of Soil.PNG",
    excerpt: {
    ...
    pdf: "/natures-aroma/media/blogs/The Soul of Soil.pdf",
  },
  {
    id: 2,
    title: {
    ...
    date: "2025-09-05",
    image: "/natures-aroma/media/blogs/Sekkuwa.PNG",
    excerpt: {
      en: "AI is evolving rapidly. Here's what's coming.",
      de: "KI entwickelt sich rasant weiter.",
      ja: "AIは急速に進化しています。",
    },
    pdf: "/natures-aroma/media/blogs/Sekkuwa.pdf",
  },
];
