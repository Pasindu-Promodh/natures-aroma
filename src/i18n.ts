  ...
  .init({
    resources: {
      en: {
        translation: {
          home: {
            title: 'Welcome to Nature Products',
            description: 'Discover our range of natural and eco-friendly products.',
          },
          about: {
            title: 'About Us',
            description: 'We are a company dedicated to providing high-quality nature-inspired products.',
          },
          products: {
            title: 'Our Products',
      ...
      de: {
        translation: {
          home: {
            title: 'Willkommen bei Nature Products',
            description: 'Entdecken Sie unser Angebot an natürlichen und umweltfreundlichen Produkten.',
          },
          about: {
            title: 'Über Uns',
            description: 'Wir sind ein Unternehmen, das sich der Bereitstellung hochwertiger naturinspirierter Produkte widmet.',
          },
          products: {
      ...
      ja: {
        translation: {
          home: {
            title: 'Nature Productsへようこそ',
            description: '自然でエコフレンドリーな製品の範囲を発見してください。',
          },
          about: {
            title: '私たちについて',
            description: '私たちは、自然にインスパイアされた高品質の製品を提供することに専念する会社です。',
          },
          products: {
            title: '私たちの製品',
            catalogue: '製品カタログ',
